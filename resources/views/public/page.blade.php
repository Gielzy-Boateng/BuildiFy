...
<body style="background-color: var(--background-color); color: var(--text-color);" x-data="{ mobileMenu: false, scrolled: false }" @scroll.window="scrolled = window.pageYOffset > 50">
    ...
    <nav class="fixed w-full z-50 transition-all duration-300" 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex-shrink-0">
                    @if($page->logo)
                        <img src="{{ asset($page->logo) }}" alt="Logo" class="h-12 w-auto">
                    @else
                        <span class="text-2xl font-bold" :class="scrolled ? 'text-gray-900' : 'text-white'" style="color: var(--primary-color);">
                            {{ $page->user->name }}
                        </span>
                    @endif
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#home" class="font-medium hover:scale-105 transition-transform" 
                       :class="scrolled ? 'text-gray-700 hover:text-gray-900' : 'text-white hover:text-gray-200'">
                        Home
                    </a>
                    <a href="#about" class="font-medium hover:scale-105 transition-transform" 
                       :class="scrolled ? 'text-gray-700 hover:text-gray-900' : 'text-white hover:text-gray-200'">
                        About
                    </a>
                    <a href="#services" class="font-medium hover:scale-105 transition-transform" 
                       :class="scrolled ? 'text-gray-700 hover:text-gray-900' : 'text-white hover:text-gray-200'">
                        Services
                    </a>
                    <a href="#contact" class="px-6 py-2 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105" 
                ...
                {{-- Mobile Menu Button --}}
                <div class="md:hidden">
                    <button @click="mobileMenu = !mobileMenu" class="p-2 rounded-lg" :class="scrolled ? 'text-gray-700' : 'text-white'">
        ...
        <div x-show="mobileMenu" 
            ...
            <div class="px-4 pt-2 pb-4 space-y-2">
                <a href="#home" @click="mobileMenu = false" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">Home</a>
                <a href="#about" @click="mobileMenu = false" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">About</a>
                <a href="#services" @click="mobileMenu = false" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 font-medium">Services</a>
    ...
    {{-- Contact Section --}}
    <section id="contact" class="py-24 relative overflow-hidden" style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color));">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="mailto:contact@example.com" class="inline-flex items-center px-8 py-4 bg-white text-gray-900 rounded-full font-bold shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                    Email Us
                </a>
                <a href="tel:+1234567890" class="inline-flex items-center px-8 py-4 border-2 border-white text-white rounded-full font-bold hover:bg-white hover:text-gray-900 transition-all duration-300">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div>
    @if($page->logo)
        <img src="{{ asset($page->logo) }}" alt="Logo" class="h-12 mb-4">
    @else
        ...
        {{ Str::limit($page->content['about_text'] ?? '', 100) }}
            ...
            <div class="border-t border-gray-800 pt-8 text-center">
                ...
                <p class="text-gray-500 text-sm mt-2">
                    Powered by <span class="text-gray-400 font-semibold">CMS Platform</span>
                </p>
            </div>
        </div>
    </footer>
